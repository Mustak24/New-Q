...
<<<<<<< HEAD
  ...
  const isAdmin =
    router.query.username == process.env.NEXT_PUBLIC_ADMIN_USERNAME;
    ...
    if (!window.navigator.onLine) {
      ...
      return setAlert([
        ...alerts,
        {
          type: "error",
          title: "No Internet",
          dec: "Login fail due to no Internet connnection.",
        },
      ]);
    }
...
>>>>>>> cc889cb3c9e53463723883c8c33763bb57b3063e
        ...
        <div className="w-screen h-screen center px-10">
          ...
          >
            ...
            <div className="w-full">
              <Button
                innerHTML="Send"
                tailwindcss="w-full max-sm:hidden"
                isLoading={isLoading}
              />
              <Button
                innerHTML="Send"
                tailwindcss="w-full sm:hidden"
                effect="active"
                isLoading={isLoading}
              />
            </div>
