...
export default function Contact() {
    ...
    return (<>
        ...
        <style jsx>{`
            #loc1:checked ~ .map .loc1{ opacity: 1; scale: 1; visibility: visible; }
            #loc1:not(:checked) ~ .map .loc1{ opacity: 0; scale: .4; visibility: hidden;}

            #loc2:checked ~ .map .loc2{ opacity: 1; scale: 1; visibility: visible; }
            #loc2:not(:checked) ~ .map .loc2{ opacity: 0; scale: .4; visibility: hidden; }

            #loc3:checked ~ .map .loc3{ opacity: 1; scale: 1; visibility: visible; }
            #loc3:not(:checked) ~ .map .loc3{ opacity: 0; scale: .4; visibility: hidden; }

            #loc1:not(:checked) ~ .navigation .loc1 .line{ transform: scaleX(0); }
            #loc1:checked ~ .navigation .loc1 .line{ transform: scaleX(1); }
        
            #loc2:not(:checked) ~ .navigation .loc2 .line{ transform: scaleX(0); }
            #loc2:checked ~ .navigation .loc2 .line{ transform: scaleX(1); }

            #loc3:not(:checked) ~ .navigation .loc3 .line{ transform: scaleX(0); }
            #loc3:checked ~ .navigation .loc3 .line{ transform: scaleX(1); }    
        `}</style>
        <main className="flex items-center flex-col py-10 text-lg">
            ...
            <div className="load-onetime-child center relative max-lg:hidden font-bold [&_.text]:hover:visible [&_.text]:hover:opacity-[1] [&_.div]:hover:w-[400px] [&_.div]:hover:text-lg">
                ...
                <div className="div w-[150px] h-[150px] center flex-col text-2xl gap-2 overflow-hidden text-white transition-all duration-200 relative bg-black rounded-full">
                    <div className="text transition-all center opacity-0 invisible font-serif font-bold duration-300 text-[1.2em]">How Can We Help You ...</div>
                    <div className="text transition-all center opacity-0 font-sans invisible duration-300">Mail : 786mkhan.coc786@gmail.com</div>
                </div>
            ...
            <div className="w-full flex max-md:flex-col center my-20 px-10 gap-5 ">
                ...
                {/* iframes body */}
                <div id="maps" className="map load-animation-opacity w-full gap-10 relative center max-w-[1000px] h-[300px] sm:h-[400px] overflow-hidden rounded-lg">

                    <div className="loc1 shrink-0 absolute bg-red-200 w-full h-full transition-all duration-500">
                        <iframe className="w-full h-full object-cover bg-transparent bottom-0 outline-none" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d1465.9886802085043!2d73.87271340463548!3d25.1247140933474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjXCsDA3JzI4LjciTiA3M8KwNTInMjIuMSJF!5e1!3m2!1sen!2sin!4v1727845240016!5m2!1sen!2sin" property="true" referrerPolicy="no-referrer-when-downgrade">Loc1</iframe>
                    </div>

                    <div className="loc2 shrink-0 absolute bg-red-200 w-full h-full transition-all duration-500">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d858.4465481435632!2d73.85759926957483!3d25.11772499861015!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjXCsDA3JzAzLjgiTiA3M8KwNTEnMjkuNyJF!5e1!3m2!1sen!2sin!4v1727850031672!5m2!1sen!2sin" className="w-full h-full object-cover bg-transparent bottom-0 outline-none" loading="lazy" referrerPolicy="no-referrer-when-downgrade">Loc2</iframe>
                    </div>

                    <div className="loc3 shrink-0 absolute bg-red-200 w-full h-full transition-all duration-500">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2021.862666382538!2d73.85628517021357!3d25.058145386390642!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39686b5bcd096e99%3A0x48e0f2fc1ec73f0f!2sNew%20Quality%20Marble%20Rajsamand!5e1!3m2!1sen!2sin!4v1727850152233!5m2!1sen!2sin" className="w-full h-full object-cover bg-transparent bottom-0 outline-none" loading="lazy" referrerPolicy="no-referrer-when-downgrade">Loc3</iframe>
                    </div>
                </div>
                    ...
                    <label htmlFor='loc2' className="loc2 w-[200px] load-self-sm">
                        <CardMobile01 innerHTML={
                            <div className="flex items-center gap-5 text-sm">
                                ...
                                <div className="flex w-[100px] flex-col">
                                    <h1>Second Store</h1>
                                    <p className="text-[.8em] font-light line-clamp-1">Pasoond Rajsamand</p>
                                </div>
                                <div className="line transition-all duration-500 absolute bg-red-500 h-[60px] w-[20px] left-0 rounded-full translate-x-[-50%]"></div>
                            </div>
                        } />
            ...
            <div className="w-full px-10 my-20 sm:px-20 center">
                <div className="bg-blue-200 w-full lg:load-animation-opacity box-content p-10 rounded-lg">
                    <div className="w-full h-full center flex-col gap-5">
                        <div className="text-sm text-center">You can also visit our showroom during business hours to explore our marble collection.</div>
                        <div className="text-[2em] text-center font-serif mt-4">Contact Us</div>
                        <div className="text-center opacity-[.7]">Feel free to reach out to us for any inquiries or to request a quote. Our team is here to assist you.</div>
                            ...
                            <div className="w-[250px]">
                                <CardPc01 innerHTML={
                                    <div className="relative gap-2 flex-col center pb-8 text-center">
                                        ...
                                        <div className="font-bold my-2">Rajsamand, Rajasthan, India</div>
                                    </div>
                                } />
                            </div>
                        </div>
